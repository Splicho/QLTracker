...
export function Leaderboard(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth={1.5}
      >
        <path d="M10.5 8h8m-8 4H13m5.5 0H16m-5.5 4H13m5.5 0H16M7 7.5H6c-1.886 0-2.828 0-3.414.586S2 9.614 2 11.5V18a2.5 2.5 0 0 0 5 0z"></path>
        <path d="M16 3.5h-5c-.93 0-1.395 0-1.776.102a3 3 0 0 0-2.122 2.122C7 6.105 7 6.57 7 7.5V18a2.5 2.5 0 0 1-2.5 2.5H16c2.828 0 4.243 0 5.121-.879C22 18.743 22 17.328 22 14.5v-5c0-2.828 0-4.243-.879-5.121C20.243 3.5 18.828 3.5 16 3.5"></path>
      </g>
    </svg>
  );
}
...
export function LinkSquare(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11.1 3.002c-3.648.007-5.56.096-6.78 1.317C3.002 5.637 3.002 7.758 3.002 12s0 6.363 1.318 7.681c1.317 1.318 3.438 1.318 7.68 1.318s6.363 0 7.68-1.318c1.222-1.22 1.312-3.132 1.318-6.78m-.518-9.383l-5.549 5.534m5.55-5.534c-.495-.495-3.822-.449-4.526-.439m4.525.439c.494.494.448 3.825.438 4.53"></path></svg>);
}

export function Clock(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><g fill="none" stroke="currentColor" strokeWidth={1.5}><circle cx={12} cy={12} r={10}></circle><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l2 2"></path></g></svg>);
}

export function CoverImage(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><g fill="none" stroke="currentColor" strokeWidth={1.5}><circle cx={7.5} cy={7.5} r={1.5} strokeLinecap="round" strokeLinejoin="round"></circle><path d="M2.5 12c0-4.478 0-6.718 1.391-8.109S7.521 2.5 12 2.5c4.478 0 6.718 0 8.109 1.391S21.5 7.521 21.5 12c0 4.478 0 6.718-1.391 8.109S16.479 21.5 12 21.5c-4.478 0-6.718 0-8.109-1.391S2.5 16.479 2.5 12Z"></path><path d="M5 21c4.372-5.225 9.274-12.116 16.498-7.458"></path></g></svg>);
}

export function DangerZone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        <path d="M10.5 11.25a1.75 1.75 0 1 0-3.5 0a1.75 1.75 0 0 0 3.5 0Zm6.5 0a1.75 1.75 0 1 0-3.5 0a1.75 1.75 0 0 0 3.5 0Z"></path>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m11 16l.293-.37c.333-.42.5-.63.707-.63s.374.21.707.63L13 16"
        ></path>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
...
export function ArrowDownLeft(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12 10.586V4h2v10H4v-2h6.586L2.293 3.707l1.414-1.414z"
      ></path>
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M12 4a8 8 0 1 0 7.4 11m.6-7v4h-4m4 0l-3-3"
      ></path>
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M3 17c0 .93 0 1.395.102 1.777a3 3 0 0 0 2.121 2.121C5.605 21 6.07 21 7 21h10c.93 0 1.395 0 1.776-.102a3 3 0 0 0 2.122-2.121C21 18.395 21 17.93 21 17m-4.5-5.5S13.186 16 12 16s-4.5-4.5-4.5-4.5M12 15V3"
      ></path>
    </svg>
  );
}
